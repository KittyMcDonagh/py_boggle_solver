...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_size_is_width_times_height(self):
        """
        Test that the size of the grid is = width * height
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        Ensure that each of the coordinatesin the grid contains letters
        """
    ...
    def test_neighbors_of_a_position(self):
        """
        Ensure that a position has 8 neighbors. This test doesnt allow for corners or edges
        """
        coords = (1, 2)
